...
class ViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let t1 = Teacher(firstName: "Ping", lastName: "Li", age: 60, gender: Gender.female, title: "Higher Mathematics")
        let t2 = Teacher(firstName: "Bo", lastName: "Tang", age: 35, gender: Gender.male, title: "Computer Network")
        let s1 = Student(firstName: "Xin", lastName: "Li", age: 21, gender: Gender.female, stuNo: "201611317")
        let s2 = Student(firstName: "MinQi", lastName: "Liu", age: 21, gender: Gender.female, stuNo: "2016110322")
        let s3 = Student(firstName: "GuangHong", lastName: "Liu", age: 20, gender: Gender.male, stuNo: "2016110320")
